...
class ItemsService:
    ...
    async def search_items(self, query: str, realm: str = "global") -> ItemsListResponse:
        """
    ...
    async def list_items(self, category: str | None = None, realm: str = "global") -> ItemsListResponse:
        """
